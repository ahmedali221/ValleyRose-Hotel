        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12">
            ...
            <div className="lg:col-span-1 space-y-6 lg:space-y-8 order-2 lg:order-1">
              ...
              >
                <h2 className="text-xl sm:text-2xl lg:text-3xl title-font text-gray-800 mb-3 lg:mb-4">
              ...
              >
                ...
                <div className="space-y-2 lg:space-y-3">
                  ...
                  <div className="flex items-center space-x-2 lg:space-x-3">
                    ...
                    <span className="text-sm sm:text-base text-gray-700 break-all">valleyrose@speed.at </span>
                  </div>
                </div>
              </motion.div>
            </div>
            ...
            <div className="lg:col-span-2 order-1 lg:order-2">
              <motion.div
                ...
                className="bg-gray-100 rounded-lg p-4 sm:p-6 lg:p-8"
              >
                {/* Progress Indicator */}
                    ...
                    <div className="flex overflow-x-auto pb-4 space-x-4">
                      {steps.map((step, index) => (
                        <div key={step.id} className="flex-shrink-0 flex flex-col items-center min-w-[80px]">
                          ...
                          <span className="text-xs mt-2 text-gray-700 font-medium text-center leading-tight">{step.name}</span>
                        </div>
                      ))}
                    </div>
                  </div>
