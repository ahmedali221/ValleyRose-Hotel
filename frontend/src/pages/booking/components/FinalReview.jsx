  ...
  if (loading) {
    return (
      ...
      >
        ...
        <p className="text-gray-600">Creating your reservation...</p>
      </motion.div>
    );
  }
    ...
    return (
      ...
      >
        <div className="bg-red-100 border border-red-300 rounded-lg p-6">
          ...
          <h3 className="text-lg font-semibold text-red-800 mb-2">Reservation Failed</h3>
    ...
    >
      ...
      >
        <div className="relative">
          {/* Outer ring */}
          <div className="w-24 h-24 rounded-full border-4 border-[#9962B9] flex items-center justify-center">
            {/* Inner circle */}
            <div className="w-16 h-16 bg-[#9962B9] rounded-full flex items-center justify-center">
      ...
      >
        ...
        <div className="space-y-2">
          <p className="text-xl text-gray-700">Reservation Number: {reservationNumber}</p>
        </div>
      </motion.div>
